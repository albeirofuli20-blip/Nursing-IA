...
export default function Home() {
  ...
  useEffect(() => { load(); }, []);
  const tabs = [["resumen", "Resumen"], ["pacientes", "Pacientes"], ["guias", "Guías"], ["planes", "Planes PAE"], ["escalas", "Escalas"], ["chat", "Chat IA"], ...(data.user?.role === "admin" ? [["usuarios", "Usuarios"]] : [])];
