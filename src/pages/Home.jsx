...
export default function Home() {
  ...
  useEffect(() => { load(); }, []);
  const tabs = [["resumen", "Resumen"], ["pacientes", "Pacientes"], ["guias", "Guías"], ["planes", "Planes PAE"], ["escalas", "Escalas"], ["chat", "Chat IA"], ["cursos", "Cursos"], ["marketplace", "Marketplace"], ["suscripciones", "Planes"], ["principios", "Principios"], ...(data.user?.role === "admin" ? [["negocio", "Negocio"], ["usuarios", "Usuarios"]] : [])];
