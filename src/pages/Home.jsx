...
import AssessmentPanel from "@/components/pae/AssessmentPanel";
...
export default function Home() {
  ...
  useEffect(() => { load(); }, []);
  const tabs = [["resumen", "Resumen"], ["pacientes", "Pacientes"], ["valoracion", "Valoración"], ["guias", "Guías"], ["planes", "Planes PAE"], ["escalas", "Escalas"], ["medicamentos", "Medicamentos"], ["laboratorios", "Laboratorios"], ["procedimientos", "Procedimientos"], ["chat", "Chat IA"], ["educacion", "Educación"], ["comunidad", "Comunidad y APS"], ["investigacion", "Investigación"], ["reportes", "Reportes"], ["notificaciones", "Notificaciones"], ["cursos", "Cursos"], ["marketplace", "Marketplace"], ["suscripciones", "Planes"], ["principios", "Principios"], ["seguridad", "Seguridad"], ["ajustes", "Ajustes"], ...(data.user?.role === "admin" ? [["negocio", "Negocio"], ["arquitectura", "Arquitectura"], ["diseno", "Diseño"], ["modulos", "Módulos"], ["usuarios", "Usuarios"]] : [])];
